...
Jest to frontend apliakcji do zarządzania audiobookami. Aplikacja z założenia została stworzona jako koncept darmowej biblioteki ale jest przygotowana do implementacji płatności dzięki dodaniu ról w systemie. Pomaga Administratorowi zautomatyzować zażądzanie taką biblioteką a użytkownikowi umożliwia swobodny odsłuch z dodatkowymi funkcjonalnościami. Wykorzystany został tu react oraz host vercel.
<br>
